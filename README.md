...
2、自编译脚本吸取各个大佬的精华 代码使用fightroad的[项目][(https://github.com/fightroad/N1-OpenWrt)<br>，
代码使用goodmen001的[项目][(https://github.com/goodmen001/My-OpenWrt)<br>
...
CONFIG_PACKAGE_luci-app-ttyd=y<br>等
### theme<br>
